  ...
  config = function()
    ...
    dracula.setup {
      overrides = {
        ...
        CmpItemKindNamespaceIcon = { link = "CmpItemKindNamespace" },
        CmpItemKindPackageIcon = { link = "CmpItemKindPackage" },
        ...
        CmpItemKindStringIcon = { link = "CmpItemKindString" },
        CmpItemKindNumberIcon = { link = "CmpItemKindNumber" },
        CmpItemKindBooleanIcon = { link = "CmpItemKindBoolean" },
        CmpItemKindArrayIcon = { link = "CmpItemKindArray" },
        CmpItemKindObjectIcon = { link = "CmpItemKindObject" },
        CmpItemKindKeyIcon = { link = "CmpItemKindKey" },
        --CmpItemKindnullIcon = { link = "CmpItemKindnull" },
